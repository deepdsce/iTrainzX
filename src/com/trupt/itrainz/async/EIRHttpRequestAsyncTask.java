...
public class EIRHttpRequestAsyncTask<IN extends Request, Result> extends HttpRequestAsyncTask<IN, Result> {
	...
	protected String getJsonResponse(String res) {
		...
		switch (request.getRequestType()) {
			case PNR_STATUS_REQUEST:
				PnrStatusResult pnrStatus = HtmlParseUtil.parsePNRData(document, ((PnrStatusRequest)request).getPnrNumber());
				Gson gson = new Gson();
